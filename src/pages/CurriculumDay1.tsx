...
Konsisten: Lebih baik berlatih 15-30 menit setiap hari daripada 3 jam sekali seminggu. Konsistensi membangun kebiasaan dan membuat telinga lebih cepat beradaptasi.`}
        ...
        <div id="chapter-1-4">
          <MaterialContent 
            ...
            content="Material untuk chapter ini sedang dipersiapkan."
          />
        </div>
      </div>

      <div className="flex justify-end mt-8 mb-12">
        <Button variant="outline" size="lg" className="mr-2">Sebelumnya</Button>
        <Button size="lg">Selanjutnya</Button>
      </div>
    </Layout>
  );
};
