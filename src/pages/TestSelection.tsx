...
const TestSelection = () => {
  ...
  const startFullTest = () => {
    ...
    toast.success('Test loaded successfully', {
      description: 'You are now ready to start the IELTS test.'
    });
        ...
        <section className="bg-white p-6 rounded-lg shadow-sm border border-slate-200">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="space-y-4">
              <h2 className="text-2xl font-semibold">Complete IELTS Test</h2>
              ...
              <ul className="list-disc list-inside text-sm text-slate-600 space-y-1">
                <li>Duration: Approximately 2 hours and 45 minutes</li>
              ...
              <Card key={module.id} className={`${module.color} border-none shadow-sm hover:shadow transition-shadow`}>
                ...
                <CardFooter>
                  <Link to={module.path} className="w-full">
                    <Button variant="outline" className="w-full" onClick={() => loadTest('sample')}>
